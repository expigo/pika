import { Key, Lightbulb, Music, Plus, Zap } from "lucide-react";
    ...
    return (
      <div style={styles.container}>
        ...
        <div style={styles.emptyState}>
          ...
          <p style={styles.emptyText}>Click the 👁️ on a track to see recommendations</p>
        </div>
      </div>
    );
  }
          ...
          return (
            ...
            >
              ...
              <div style={styles.meta}>
                {track.bpm && <span style={styles.metaItem}>{Math.round(track.bpm)}</span>}
                {camelot && (
