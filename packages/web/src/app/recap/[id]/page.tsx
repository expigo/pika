...
import { Radio, Music2, Heart, Clock, Calendar, User, Share2, Check, ChevronDown, ChevronUp } from "lucide-react";

// API base URL
function getApiBaseUrl(): string {
    if (typeof window === "undefined") return "";
    // In production, use the deployed cloud URL
        ...
        return (
            <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center p-4">
                <div className="text-center">
                    ...
                    <p className="text-slate-500">This session recap may have expired or doesn&apos;t exist.</p>
                </div>
            </div>
        );
    }
            ...
            <div className="max-w-2xl mx-auto">
                ...
                <div className="bg-slate-800/50 backdrop-blur-xl rounded-3xl border border-slate-700/50 shadow-2xl overflow-hidden mb-6">
                    ...
                    <div className="px-6 py-6 text-center border-b border-slate-700/50">
                        ...
                        <h2 className="text-2xl font-bold text-white mb-2">{recap.djName}</h2>
