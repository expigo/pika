 ...
 * pasting into the desktop app. Dancers sign in via magic link (browser) or email OTP code —
 * the installed PWA's cookie jar is unreachable by mailed links, so the code is typed inside it.
 */
